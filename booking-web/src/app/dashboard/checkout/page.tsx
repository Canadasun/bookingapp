            ...
            <div key={s} className="flex items-center gap-1 shrink-0">
              ...
              <button type="button" disabled={!done} onClick={() => done && setStep(s)}
                ...
                <div className={cn("w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center transition-colors",
                  done ? "bg-violet-600 text-white" : cur ? "bg-violet-600 text-white ring-4 ring-violet-100" : "bg-gray-100 text-gray-500"
                )}>
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-3">
                ...
                <div>
                  <label htmlFor="custom-date" className="mb-1 block text-xs font-semibold text-amber-900">Date</label>
                  <Input
                    id="custom-date"
                    type="date"
