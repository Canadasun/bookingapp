...
export const metadata: Metadata = {
  alternates: buildAlternates("/for/toronto"),
  title: "Appointment Booking Software for Toronto Service Businesses | Pulse",
  description: "Pulse is the simplest online booking software for salons, spas, barbers, and wellness businesses in Toronto. CAD pricing, no-show protection, free to start.",
  openGraph: {
    title: "Appointment Booking Software Toronto | Pulse Appointments",
    description: "Online booking for Toronto salons, spas, and service businesses. CAD pricing, free to start.",
  },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Booking Software for Toronto", item: "https://www.pulseappointments.com/for/toronto" },
  ],
};
...
const features = [
  ...
  },
  {
    ...
    body: "Toronto's service market is competitive. Protect every slot with deposits and automatic no-show charges — without a single awkward conversation.",
  },
  {
    icon: Bell,
    title: "Automated reminders",
    body: "Email and SMS reminders before every appointment. Built for Toronto's busy clients who book weeks in advance.",
  },
];
...
export default function TorontoPage() {
  return (
    <main id="main-content" className="min-h-screen bg-[#F8F5EF]">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-orange-400 to-amber-600">
            Toronto service businesses
          </span>
        </h1>
        <p className="text-lg text-slate-500 max-w-xl mx-auto mb-10 leading-relaxed">
          Built for Toronto salons, spas, barbers, lash artists, massage therapists, and wellness professionals. CAD pricing. No USD surprises. Free to start.
        </p>
      ...
      {/* Why Toronto businesses choose Pulse */}
      <section className="py-16 bg-white/60 border-y border-[#E9DDCB]">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl font-bold text-slate-900 text-center mb-12">Why Toronto businesses choose Pulse</h2>
      ...
      {/* Works for every Toronto service business */}
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-3">Works for every Toronto service business</h2>
          <p className="text-slate-500 mb-10">From downtown studios to neighbourhood shops — Pulse fits any appointment-based service.</p>
      ...
      <section className="py-20 bg-[#19212B]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Start taking Toronto bookings today</h2>
