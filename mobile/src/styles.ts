...
export const cal = StyleSheet.create({
  ...
  filterChip:    { borderRadius:8, paddingHorizontal:12, paddingVertical:6, backgroundColor:'transparent' },
  filterChipOn:  { backgroundColor:GRAY_100 },
  filterText:    { fontSize:13, fontWeight:'500', color:GRAY_500 },
  filterTextOn:  { color:GRAY_900, fontWeight:'600' },
  ...
  aptRow:        { flexDirection:'row', alignItems:'center', gap:10, paddingHorizontal:16, paddingVertical:8, borderBottomWidth:1, borderBottomColor:GRAY_100, backgroundColor:'#fff' },
  aptBar:        { width:4, height:26, borderRadius:2 },
  aptClient:     { fontSize:14, fontWeight:'700', color:GRAY_900 },
  aptService:    { fontSize:11, color:GRAY_500, marginTop:1 },
  aptTime:       { fontSize:14, fontWeight:'600', color:GRAY_900 },
  aptDur:        { fontSize:11, color:GRAY_400, marginTop:1 },
